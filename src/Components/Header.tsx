  ...
  return (
    <header className="container">
      <nav className="header">
        ...
        >
          <p>
            <span className="header--green site-title invisible">T</span>
            <span className="header--green site-title invisible">y</span>
            <span className="header--green site-title invisible">p</span>
            <span className="header--green site-title invisible">e</span>
            <span className="site-title invisible">R</span>
            <span className="site-title invisible">u</span>
            <span className="site-title invisible">s</span>
            <span className="site-title invisible">h</span>
          </p>
          <svg
            ref={hiderRef}
